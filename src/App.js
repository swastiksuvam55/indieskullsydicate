      ...
      <div id='bg-container' className='flex flex-col h-screen'>
        ...
        <div className='flex justify-center items-end flex-grow'>
          ...
          <div className='h-192 font-sans -translate-x-32'>
            <Animated animationIn="fadeInLeft" animationOut="fadeOut" isVisible={visible}>
            <a className='text-white text-2xl drop-shadow-lg font-papyrus' href='/landing'>Click on me to know me</a>
            </Animated>
          </div>
          </div>
        </div>
